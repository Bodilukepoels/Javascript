...
function grandTotal() {
    ...
    if (turn == (2 - 1)) {
        ...
        total2 += parseInt(document.getElementById("topTotal2").textContent);
        total2 += parseInt(document.getElementById("totalBottom2").textContent);
    }

    document.getElementById("grandTotal").textContent = total;
    
    document.getElementById("grandTotal2").textContent = total2;
